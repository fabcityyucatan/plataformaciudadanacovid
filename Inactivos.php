...
<div class="menus" id="menu">
	...
	<img class="logoMenu" id="logoMenu" src="img/logos/menulogo.png" alt="">
	...
	<div class="listaMenu" id="listaMenu">
            ...
            <ul id="nav">
                ...
                <li><a href="Administrador.php">Publicados</a></li>
...
<?php
 ...
 $resultado = mysqli_query($con,$query);
        ...
        while($filas = mysqli_fetch_assoc($resultado)){
          ...
          echo "<li><a style='text-decoration: none;margin: 0;' href='Publicar.php?id=".$filas['idIniciativa']."'><div id=tarjet>";
